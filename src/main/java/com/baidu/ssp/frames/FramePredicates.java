...
public final class FramePredicates {
    ...
    public static Predicate<Row> onTitle(final String title, final Predicate predicate) {
    ...
    public static FramePredicates from(final String title, final Predicate predicate) {
        return new FramePredicates(onTitle(title, predicate));
    }

    public FramePredicates compound(final String title, final Predicate predicate) {
        this.rowPredicate = Predicates.and(rowPredicate, onTitle(title, predicate));
        return this;
    }
